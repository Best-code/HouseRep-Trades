...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.L_Year = QLabel(self.groupBox)
        self.L_Year.setObjectName(u"L_Year")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.L_Year.sizePolicy().hasHeightForWidth())
        self.L_Year.setSizePolicy(sizePolicy3)
        self.L_Year.setMinimumSize(QSize(128, 128))
        self.L_Year.setMaximumSize(QSize(16777215, 336))
        self.L_Year.setFont(font2)

        self.horizontalLayout.addWidget(self.L_Year)

        self.DE_Year = QDateEdit(self.groupBox)
        self.DE_Year.setObjectName(u"DE_Year")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.DE_Year.sizePolicy().hasHeightForWidth())
        self.DE_Year.setSizePolicy(sizePolicy4)
        self.DE_Year.setFont(font2)
        self.DE_Year.setAccelerated(False)
        self.DE_Year.setMaximumDate(QDate(2025, 1, 1))
        self.DE_Year.setMinimumDate(QDate(2023, 1, 1))

        self.horizontalLayout.addWidget(self.DE_Year)
        ...
        self.horizontalLayout_2.addWidget(self.L_After)

        self.DE_After = QDateEdit(self.groupBox)
        self.DE_After.setObjectName(u"DE_After")
        self.DE_After.setEnabled(False)
        ...
        self.horizontalLayout_2.addWidget(self.DE_After)
        ...
        self.DE_Before.setEnabled(False)
